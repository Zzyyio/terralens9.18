  ...
  return (
    <main id="main" className="mx-auto max-w-[1280px] px-5 pb-24 pt-24">
      ...
      <h1 className="mt-3 font-display text-4xl text-chalk md:text-5xl">
        {SHIPPED.length} labs. {complete} ready for a full lesson.
      </h1>
      <p className="mt-4 max-w-2xl text-mist">
        Filter by realm, then by a curriculum tag if you need one. KS3 / GCSE / A-level / NGSS / APES
        are filters, not the identity of the studio. A lab without a model does not get a card.
      </p>
