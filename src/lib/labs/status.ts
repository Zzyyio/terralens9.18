 ...
 */
export const LAB_STATUS: Record<string, LabStatus> = {
  seasons: "complete",
  rotation: "complete",
...
export function labStatus(slug: string): LabStatus {
...
export function teacherScriptReady(script: string): boolean {
